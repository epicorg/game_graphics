...
public class SFOGLTextureModel {
	...
	public static int getType(SFImageFormat format){
		switch (format) {
			case ALPHA: return GLES20.GL_ALPHA;
			case GRAY: return GLES20.GL_LUMINANCE;
			case GRAY_ALPHA: return GLES20.GL_LUMINANCE_ALPHA;
			case RGB: return GLES20.GL_RGB;
			case RGB565: return GLES20.GL_RGB;
			case RGBA: return GLES20.GL_RGBA;
			case RGBA4: return GLES20.GL_RGBA;
			case RGBA5551: return GLES20.GL_RGBA;
			default: return GLES20.GL_RGBA;
	...
	public static int getFormat(SFImageFormat format){
		switch (format) {
			case ALPHA: return GLES20.GL_UNSIGNED_BYTE;
			case GRAY: return GLES20.GL_UNSIGNED_BYTE;
			case GRAY_ALPHA: return GLES20.GL_UNSIGNED_BYTE;
			case RGB: return GLES20.GL_UNSIGNED_BYTE;
			case RGB565: return GLES20.GL_UNSIGNED_SHORT_5_6_5;
			case RGBA: return GLES20.GL_UNSIGNED_BYTE;
			case RGBA4: return GLES20.GL_UNSIGNED_SHORT_4_4_4_4;
			case RGBA5551: return GLES20.GL_UNSIGNED_SHORT_5_5_5_1;
			default: return GLES20.GL_RGBA;
		}
	}
}
