...
public class SFOGLFrameBuffer {
    ...
    public void attachCubeMap(int attachment, SFOGLCubeMap cubmap, int index) {
        GLES20.glFramebufferTexture2D(GLES20.GL_FRAMEBUFFER, attachment, SFOGLCubeMap.MAPS[index], cubmap.getTextureObject(), 0);
    }
