...
public class SFOGLModelViewMatrix {
	...
	private SFMatrix3f matrix=new SFMatrix3f();
	private SFVertex3f position=new SFVertex3f();

	private LinkedList<SFMatrix3f> stackM=new LinkedList<SFMatrix3f>();
	private LinkedList<SFVertex3f> stackP=new LinkedList<SFVertex3f>();
