...
public class SFOGLUniform {
    ...
    public void setValue(float... value) {
        ...
        if (uniformLocation != -1) {
            switch (value.length) {
                case 1:
                    GLES20.glUniform1fv(uniformLocation, 1, value, 0);
                    break;
                case 2:
                ...
                case 4:
                    ...
                    break;
                case 9:
                    GLES20.glUniformMatrix3fv(uniformLocation, 1, false, value, 0);
                    break;
                case 16:
                    GLES20.glUniformMatrix4fv(uniformLocation, 1, false, value, 0);
                    break;
                default:
            }
        }
    ...
    public void setValuei(int... value) {
        ...
        if (uniformLocation != -1) {
            switch (value.length) {
                case 1:
                    GLES20.glUniform1iv(uniformLocation, 1, value, 0);
                    break;
                case 2:
                    GLES20.glUniform2iv(uniformLocation, 1, value, 0);
                    break;
                case 3:
                    GLES20.glUniform3iv(uniformLocation, 1, value, 0);
                    break;
                case 4:
                    GLES20.glUniform4iv(uniformLocation, 1, value, 0);
                    break;
                default:
            }
        }
