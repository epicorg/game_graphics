...
public class GraphicsView extends GLSurfaceView {
    ...
    private static final String LOG_TAG = "GraphicsView";
    ...
    public GraphicsView(Context context, Player me, ArrayList<Team> teams, Map map, CountDownLatch startSignal,
                        int groundWidth, int groundHeight, SettingsScreen settingsScreen) {
        super(context);
    ...
    public void onGameGo() {
        queueEvent(() -> touchListener.setReadyToPlay(true));
    }
    ...
    public class GraphicsRenderer implements Renderer {
        ...
        private final ArrayList<TextLabel> labels = new ArrayList<>();
        ...
        public void onSurfaceChanged(GL10 gl, final int width, final int height) {
            ...
            final ButtonsControl buttonsControl = new ButtonsControl(program, camera.getOrthogonalMatrix(), buttonMaster);
        ...
        public void onDrawFrame(GL10 gl) {
            ...
            program.setupProjection(camera.getOrthogonalMatrix());
            buttonMaster.draw();
        }
