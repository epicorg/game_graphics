...
public class GameActivity extends Activity implements GameHandlerListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GameHandler gameHandler = new GameHandler(new StatusInterpreter(context, messageScreen, gamePositionSender, this), mapInterpreter,
    ...
    public void onMapReceived() {
        ...
        LinearLayout graphicsContainerLayout = findViewById(R.id.graphics_view_container);
