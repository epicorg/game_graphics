...
/**
 * Cylindrical obstacle: vase.
 *
 * @author Rocca
 */
public class Vase implements MazeObject {
    ...
    /**
     * Creates a new Vase of specified dimension and texture.
     *
     ...
     */
    public Vase(Circle c, double height, int texture_id) {
        this.c = c;
    ...
    public MazeObject cloneFromData(String position, String size, int textureId) {
        ...
        return new Vase(new Circle(new SFVertex3f(posX, posY, posZ), sizeX), sizeY, textureId);
    }
}
