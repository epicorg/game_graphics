...
public class PositionMoveListenerXZWithCollisions implements PositionMoveListenerInterface {
    ...
    public static final String LOG_TAG = "PositionMoveListenerXZWithCollisions";
    ...
    public PositionMoveListenerXZWithCollisions(SFVertex3f position, SFVertex3f direction, CollisionMediator cm, CollisionBox box) {
